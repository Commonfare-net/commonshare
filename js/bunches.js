...
function plotbunches(mydata) {
	...
	var blabels = labelsg.append("text")
		...
		.attr("startOffset", "50%")
		.text(function(){if(lang=="hr")return "commoneri"; if(lang=="it")return "commoners"; return "commoners"})
		...
		.style("text-anchor", "middle") //place the text halfway on the arc
		.attr("startOffset", "50%")
		.text(function(){if(lang=="hr")return "unosi"; if(lang=="it")return "inserzione"; return "listings"})
	...
	var bsociallabels = labelsg.append("text")
		...
		.style("text-anchor", "middle") //place the text halfway on the arc
		.attr("startOffset", "50%")
		.text(function(){if(lang=="hr")return "priče"; if(lang=="it")return "storie"; return "stories"})
