...
var transactionlabels = cookieg.append("text")
	...
	.style("text-anchor", "middle") //place the text halfway on the arc
	.attr("startOffset", "50%")
	.text(function(){if(lang=="hr")return "transkacije"; if(lang=="it")return "transazioni"; return "transactions";})
...
var sociallabels = cookieg.append("text")
	...
	.style("text-anchor", "middle") //place the text halfway on the arc
	.attr("startOffset", "50%")
	.text(function(){if(lang=="hr")return "razgovori"; if(lang=="it")return "sociali"; return "social";})
...
function plotcookie(graphdata, mydata) {
  ...
  graphdata.links.forEach(function(e) {
	...
	var cumu_totals = JSON.parse(JSON.stringify(mydata.cumu));
