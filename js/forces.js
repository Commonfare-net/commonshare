...
//This is the standard force-directed simulation
...
//This is the clustering simulation, uses the forceCluster function together 
...
/**
* Switches the simulation between force-directed layout and
* clustered layout based on 'checked' status of chk
* @param {checkbox} chk - HTML checkbox element
*/
function toggleGroups(chk) {
    sim = (chk.checked) ? community_sim : simulation;
...
/**
* Clustering function to bunch nodes that are in the same cluster together
* @param {float} alpha - Current alpha value of simulation (begins at 1.0)
*/
